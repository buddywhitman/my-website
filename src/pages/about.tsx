  ...
  return (
    <Box pb={20}>
      ...
      <Flex alignItems="flex-start" direction="column" pt={10} px={{ base: 6, md: 10, lg: 20 }}>
        ...
        >
          <Text className="mono-label" fontSize="10px" color="var(--accent)" mb={{ base: 4, md: 6 }}>
            THE LONG VERSION
          </Text>
          <Heading
            as="h2"
            className="editorial"
            fontSize={{ base: "17vw", md: "13vw", lg: "11vw" }}
            fontWeight="600"
            lineHeight="0.85"
          ...
          >
            How I got <Box as="span" className="tiedye-text">here.</Box>
          </Heading>
        </MotionBox>
